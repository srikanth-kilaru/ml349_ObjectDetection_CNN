...
def Inception_ResNetv2_fast_rcnn(model):
    return build_generic_detection_model(
        model, Inception_ResNetv2.add_inception_resnetv2_xxs_conv5_body,
...
def Inception_ResNetv2_faster_rcnn(model):
    assert cfg.MODEL.FASTER_RCNN
    return build_generic_detection_model(
        model, Inception_ResNetv2.add_inception_resnetv2_xxs_conv5_body,
        VGG16.add_VGG16_roi_fc_head
